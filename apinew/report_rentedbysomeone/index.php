...
class RentBySomeone{
  function rentBySomeone(){
    ...
    LEFT JOIN (
      ...
      WHERE p.is_active IN (1,2) AND p.post_id = r.post_id AND tenant_id = $tenant_id";
    ...
    $response = (object) [
      'message' => 'Posts rented by someone retrieved successfuly',
      'rent' => $rent
    ];
...
$RentBySomeone = new RentBySomeone;
echo $RentBySomeone->rentBySomeone();
?>