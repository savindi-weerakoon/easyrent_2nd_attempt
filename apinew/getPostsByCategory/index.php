...
class PostsByCategory{
  function getPostsByCategory(){
    ...
    LEFT JOIN (
      ...
      WHERE p.is_active IN (1,2) AND p.category_id = $category_id
      ...
      $response = (object) [
        'message' => 'posts retrieved according to the category successfully',
        'posts' => $posts
      ];
...
$PostsByCategory = new PostsByCategory;
echo $PostsByCategory->getPostsByCategory();
?>