<?php
    ...
    class User {
        function Usercreate ($username, $firstname, $lastname, $phone, $email, $password) {
            $db = new Connect;
            $insert_query = "INSERT INTO user(username, firstname, lastname, phone, email, password) 
            VALUES (:username, :firstname, :lastname, :phone, :email, :passwordnew)";
        ...
        function checkUsers () {
            ...
            if (empty($username)) {
                ...
                if (!preg_match('/^[A-Za-z\s ]+$/', $username)) {
                    ...
                    $this->Usercreate ($username, $firstname, $lastname, $phone, $email, $passwordnew);
                }
            } 
        }
    }
